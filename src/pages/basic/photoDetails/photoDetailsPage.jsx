...
const PhotoDetailsPage = ({ setShow }) => {
    ...
    return (
        <div className="PhotoDetailsPage">
            <Link to='/gallery' style={{ width: 'auto', marginLeft: '70px'}}>
                <Button className="goBack-btn"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
            ...
            {isLoading
                ...
                <Container>
                    <Row>
                        ...
                        <Col md={{ span: 5, offset: 1 }} style={{ position: 'relative' }}>
